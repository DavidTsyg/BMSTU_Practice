...
int main()
{
    ...
    if (L21 == min) std::cout << "На минимальном расстоянии находится точка " << x2 << " " << y2 << endl;
    if (L31 == min) std::cout << "На минимальном расстоянии находится точка " << x3 << " " << y3 << endl;
    if (L41 == min) std::cout << "На минимальном расстоянии находится точка " << x4 << " " << y4 << endl;
    if (L51 == min) std::cout << "На минимальном расстоянии находится точка " << x5 << " " << y5 << endl;
    get.h;
    return 0;
}
